...
export const DEFAULT_SOURCES: Source[] = [
  ...
  { id: "the-guardian", name: "The Guardian", domain: "theguardian.com", tier: 1 },
  ...
  { id: "the-economist", name: "The Economist", domain: "economist.com", tier: 2 },
  { id: "nyt", name: "NYT", domain: "nytimes.com", tier: 2 },
  { id: "washington-post", name: "Washington Post", domain: "washingtonpost.com", tier: 2 },
  ...
  { id: "global-times", name: "Global Times", domain: "globaltimes.cn", tier: 3 },
  { id: "france24", name: "France24", domain: "france24.com", tier: 3 },

  // Tier 4 — Independent / Investigative (tracked only)
  { id: "the-intercept", name: "The Intercept", domain: "theintercept.com", tier: 4 },
  ...
  { id: "the-gray-zone", name: "The Gray Zone", domain: "thegrayzone.com", tier: 5 },
];
