  ...
  return (
    <div className="mx-auto max-w-[900px] space-y-6">
      <div><h1 className="font-heading text-[2rem] font-bold leading-none tracking-[-0.02em] text-[var(--nn-text)]">Investigate</h1>
        <p className="mt-1.5 font-sans text-[0.9rem] text-[var(--nn-text-dim)]">Live analysis — your query runs through our pipeline in real time via Fireworks-hosted DeepSeek V4 Flash. Not cached, not pre-computed.</p></div>
